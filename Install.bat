...
ECHO.
ECHO Building and installing SurfaceGameBasics.
PAUSE
ECHO.
...
:SurfaceGameBasics
ECHO Building SurfaceGameBasics...
%MsBuildPath% SurfaceGameBasics\SurfaceGameBasics.csproj %MSBuildParameters%
IF ERRORLEVEL 1 goto SurfaceGameBasicsError
ECHO Generating SurfaceGameBasics XML...
CreateShellXML.vbs SurfaceGameBasics\InstalledAppInfo\SurfaceGameBasics.xml "%CD%" SurfaceGameBasics %ExeDirPath%
ECHO Installing SurfaceGameBasics to Surface Shell...
ECHO.
goto COMPLETE

:SurfaceGameBasicsError
SET BuildErrors=true
ECHO Error building SurfaceGameBasics. Please build in Visual Studio and rerun this batch file.
ECHO.
